...
func SeedCatalog(db *gorm.DB) error {
	...
	sources := []catalog.Source{
		...
		{ID: "kongfz-cn", Name: "Kongfz / 孔夫子旧书网", Region: "CN", Locale: "zh-CN", Timezone: "Asia/Shanghai", Kind: "marketplace", Adapter: "kongfz_cn", DefaultFormat: "physical", AllowedFormats: "physical", AccessMethod: "browser", BaseURL: "https://www.kongfz.com", AllowedHosts: "www.kongfz.com,search.kongfz.com,shop.kongfz.com,book.kongfz.com", Capabilities: "active_discovery,sold_discovery,listing_detail", AccessStatus: "review", RatePerMinute: 3, Enabled: false},
